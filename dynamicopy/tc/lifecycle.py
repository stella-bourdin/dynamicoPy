...
def identify_lifecycle(tracks, ss = None,):
    ...
    tracks = tracks.assign(lag_climax_slp = (t_interm.time - t_interm.time_slp).astype('timedelta64[h]') )
    tracks = tracks.assign(lag_climax_wind = (t_interm.time - t_interm.time_wind).astype('timedelta64[h]') )
    return tracks
